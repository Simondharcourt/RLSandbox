...
# todo: add a maze. The rewards should be harder to determine.
# change for dot each episode. Combine with maze (deep learning might be more convenient)
# what if the target is moving ? probably has to go to deeprl.
